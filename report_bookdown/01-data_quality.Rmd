...
pacman::p_load(rstudioapi,dplyr, ggplot2, lubridate, devtools, tidyr,magrittr, 
               lemis,zoo,gdata, knitr, DT, plotly, countrycode)
...
**If we have a look at the "value" variable, we can notice that the years 2008, 2009, 2010 and 2014 only contain missing values**
