...
refused %>% 
  ...
  plot_ly(x=~reorder(genus, desc(percentage)), y=~percentage, 
          color=~genus) %>%
  add_bars() %>%
  layout(title = "<b>Genus of refused segments (Top 15)</b>",
...
data %>% 
  ...
  plot_ly(x=~reorder(country_origin, desc(total)), y=~total, 
        color=~country_origin) %>% 
  add_bars() %>%
  layout(title = "<b>Most common country of origin (by number) (Top 15)</b>",
         xaxis= list(title= "<b>Country of origin</b>" ,tickangle=-65),
...
data %>% 
  ...
  plot_ly(x=~reorder(country_origin, desc(total)), y=~total, 
        color=~country_origin) %>% 
  add_bars() %>%
  layout(title = "<b>Most common country of origin (by Kilograms) (Top 15)</b>",
         xaxis= list(title= "<b>Country of origin</b>" ,tickangle=-65),
         yaxis = list(title = "<b>Total</b>"))
...
plot_ly(country_origin_top5, x=~country_origin, 
                            ...
                            type="bar", color=~taxa) %>%
  layout(title = "<b>Common taxa by country of origin</b>",
         xaxis= list(title= "<b>Country of origin</b>" ,tickangle=-65),
         yaxis = list(title = "<b>Total</b>"))
...
data %>% 
  ...
  plot_ly(x=~reorder(country_imp_exp, desc(total)), y=~total, 
        color=~country_imp_exp) %>% 
  add_bars() %>%
  layout(title = "<b>Most common country of export (by number) (Top 15)</b>",
         xaxis= list(title= "<b>Country of export</b>" ,tickangle=-65),
         yaxis = list(title = "<b>Total</b>"))
...
data %>% 
  ...
  plot_ly(x=~reorder(country_imp_exp, desc(total)), y=~total, 
        color=~country_imp_exp) %>% 
  add_bars() %>%
  layout(title = "<b>Most common country of export (by Kilograms) (Top 15)</b>",
         xaxis= list(title= "<b>Country of export</b>" ,tickangle=-65),
         yaxis = list(title = "<b>Total</b>"))
...
plot_ly(country_export_top5, x=~country_imp_exp, 
                            y=~percentage, group= ~taxa, 
                            type="bar", color=~taxa) %>%
  layout(title = "<b>Common taxa by country of export</b>",
         xaxis= list(title= "<b>Country of export</b>" ,tickangle=-65),
         yaxis = list(title = "<b>Total</b>"))
...
data %>% 
  ...
  plot_ly(x=~reorder(port, desc(total)), y=~total, 
        color=~port) %>% 
  add_bars() %>%
  layout(title = "<b>Most common ports (by number) (Top 15)</b>",
         xaxis= list(title= "<b>Port</b>" ,tickangle=-65),
         yaxis = list(title = "<b>Total</b>"))
...
data %>% 
  ...
  plot_ly(x=~reorder(port, desc(total)), y=~total, 
        color=~port) %>% 
  add_bars() %>%
  layout(title = "<b>Most common ports (by Kilograms) (Top 15)</b>",
         xaxis= list(title= "<b>Port</b>" ,tickangle=-65),
         yaxis = list(title = "<b>Total</b>"))
...
plot_ly(ports_top5, x=~port, 
                            y=~percentage, group= ~taxa, 
                            type="bar", color=~taxa) %>%
  layout(title = "<b>Common taxa by port</b>",
         xaxis= list(title= "<b>Port</b>" ,tickangle=-65),
         yaxis = list(title = "<b>Total</b>"))
...
plot_ly(routes_top5, x=~route, 
                            y=~percentage, group= ~taxa, 
                            type="bar", color=~taxa) %>%
  layout(title = "<b>Common taxa by route</b>",
...
data %>% 
  ...
  plot_ly(x=~reorder(purpose, desc(total)), y=~total, 
        color=~purpose) %>% 
  add_bars() %>%
  layout(title = "<b>Most common type of purpose (by number) </b>",
...
data %>% 
  ...
  plot_ly(x=~reorder(purpose, desc(total)), y=~total, 
        color=~purpose) %>% 
  add_bars() %>%
  layout(title = "<b>Most common type of purpose (by Kilograms)</b>",
         xaxis= list(title= "<b> Purpose</b>" ,tickangle=-65),
         yaxis = list(title = "<b>Total</b>"))
...
purpose_taxa<- plot_ly(purpose_taxa, x=~purpose, 
                            y=~percentage, group= ~taxa, 
                            type="bar", color=~taxa) %>%
  layout(title = "<b>Common taxa by purpose</b>",
         xaxis= list(title= "<b>Purpose</b>" ,tickangle=-65),
         yaxis = list(title = "<b>Total</b>"))
...
data %>% 
  ...
  plot_ly(x=~reorder(taxa, desc(total)), y=~total, 
        color=~taxa) %>% 
  add_bars() %>%
  layout(title = "<b>Most common type of taxa (by number) </b>",
         xaxis= list(title= "<b>Taxa </b>" ,tickangle=-65),
         yaxis = list(title = "<b>Total</b>"))
...
data %>% 
  ...
  plot_ly(x=~reorder(taxa, desc(total)), y=~total, 
        color=~taxa) %>% 
  add_bars() %>%
  layout(title = "<b>Most common type of taxa (by Kilograms)</b>",
         xaxis= list(title= "<b> Taxa </b>" ,tickangle=-65),
         yaxis = list(title = "<b>Total</b>"))
...
genus %>% mutate(percentage=percentage*100) %>%
  ...
  plot_ly(x=~reorder(genus, desc(percentage)), y=~percentage, 
        color=~genus) %>% 
  add_bars() %>%
  layout(title = "<b>Genus (or higher-level taxonomic name) of the wildlife product (Top 15)</b>",
         xaxis= list(title= "<b>Genus</b>" ,tickangle=-65),
         yaxis = list(title = "<b>Percentage</b>"))
...
plot_ly(genus_species, x=~genus, 
  ...
  layout(title = "<b>Common species by genus</b>",
         xaxis= list(title= "<b>Genus</b>" ,tickangle=-65),
         yaxis = list(title = "<b>Total</b>"))
...
data %>% 
  ...
  plot_ly(x=~reorder(genus, desc(total)), y=~total, 
        color=~genus) %>% 
  add_bars() %>%
  layout(title = "<b>Most common type of genus (by number) </b>",
         xaxis= list(title= "<b> Genus </b>" ,tickangle=-65),
         yaxis = list(title = "<b>Total</b>"))
...
data %>% 
  ...
  plot_ly(x=~reorder(genus, desc(total)), y=~total, 
        color=~genus) %>% 
  add_bars() %>%
  layout(title = "<b>Most common type of genus (by Kilograms)</b>",
         xaxis= list(title= "<b> Genus </b>" ,tickangle=-65),
         yaxis = list(title = "<b>Total</b>"))
...
species %>% mutate(percentage=percentage*100) %>%
  ...
  plot_ly(x=~reorder(species, desc(percentage)), y=~percentage, 
        color=~species) %>% 
  add_bars() %>%
  layout(title = "<b>Species of the wildlife product (Top 15)</b>",
...
plot_ly(species_description, x=~species, 
  ...
  layout(title = "<b>Common descriptions by species</b>",
         xaxis= list(title= "<b>Species</b>" ,tickangle=-65),
         yaxis = list(title = "<b>Total</b>"))
...
plot_ly(species_source, x=~species, 
  ...
  layout(title = "<b>Common sources by species</b>",
         xaxis= list(title= "<b>Species</b>" ,tickangle=-65),
         yaxis = list(title = "<b>Total</b>"))
...
data %>% 
  ...
  plot_ly(x=~reorder(species, desc(total)), y=~total, 
        color=~species) %>% 
  add_bars() %>%
  layout(title = "<b>Most common type of species (by number) </b>",
         xaxis= list(title= "<b> Species </b>" ,tickangle=-65),
         yaxis = list(title = "<b>Total</b>"))
...
data %>% 
  ...
  plot_ly(x=~reorder(species, desc(total)), y=~total, 
        color=~species) %>% 
  add_bars() %>%
  layout(title = "<b>Most common type of species (by Kilograms)</b>",
         xaxis= list(title= "<b> Species </b>" ,tickangle=-65),
         yaxis = list(title = "<b>Total</b>"))
